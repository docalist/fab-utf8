...
//    	 	"contextmenu",	// Menu contextuel
	 	...
	 	core: 
        {
        	initially_open : ["#root"], //, "fields", "indices"],
			strings:
			{
...
*/
	...
	*/
    ...
    function loadToolbar(tree, node)
    {
		...
		console.log("Liste des noeuds : ", nodesTypes);
		...
		*/
		...
		{
			toolbar.add(types[nodeType].icon.remove, types[nodeType].label.remove.format(tree.get_text(node), nodeType), removeCurrentNode);
		};
